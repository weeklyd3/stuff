...
// By the jQuery team. This file was downloaded from
// http://code.jquery.com/jquery-1.7.1.min.js, then
// unminified to create the source file shown below.
// Because it was unminified from a minified version,
// the variable names are still short.
(function (a, b) {
	function cy(a) {
		...
		: (f.fn.offset = function (a) {
			...
			while ((b = b.parentNode) && b !== i && b !== h) {
				...
				(c = j ? j.getComputedStyle(b, null) : b.currentStyle),
					...
					((l += b.offsetTop),
						(m += b.offsetLeft),
						f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !cw.test(b.nodeName)) && ((l += parseFloat(c.borderTopWidth) || 0), (m += parseFloat(c.borderLeftWidth) || 0)),
						(e = d),
						(d = b.offsetParent)),
