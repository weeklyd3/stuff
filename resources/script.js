...
function preview() {
    ...
    var goodtext1='<style>#AAAAAAAAAA { @page { size: 8.5in 11in; margin: 0.79in } font-family:"Times New Roman"; white-space: pre-wrap; } </style><pre id="AAAAAAAAAA">'+rawtext+'</pre>';
